...
# map 78.1% resnet_channel3  log_dir : stage0_l3_l4ca
...
class ResNet_channel3(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, num_features=0,
        ...
        # self.layer2_mp = nn.MaxPool2d(kernel_size=4, stride=4)
        # self.layer3_mp = nn.MaxPool2d(kernel_size=2, stride=2)

        self.layer2_mp = nn.MaxPool2d(kernel_size=2, stride=2)
        # self.layer3_mp = nn.MaxPool2d(kernel_size=2, stride=2)


        self.layer2_ca = MultiHeadAttention(model_dim = 512,  num_heads = 4, dropout = 0.0, compression = 2)
    ...
    def forward(self, x):
        ...
        # l3_side = self.layer3_mp(l3_side)
