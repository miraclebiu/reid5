...
class ResNet_channel3(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, num_features=0,
        ...
        self.layer4_reduce = [self._cbr2(in_channels = 2048, out_channels = num_features)] * (self.num_bypath+1)
    ...
    def forward(self, x):
        ...
        l4_part_fea = l4_outs[1]
        l4_fea.append(l4_part_fea[:,:,0:h_h,:])
        l4_fea.append(l4_part_fea[:,:,h_h:,:])
