...
class DRN3(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, num_features=0, 
        ...
        super(DRN3, self).__init__()

        self.depth = depth
        self.pretrained = pretrained

        # Construct base (pretrained) resnet
        if depth not in DRN3.__factory:
    ...
    def forward(self, x):
        ...
        for name, module in self.base._modules.items():
            ...
            if name == 'layer5':
                ...
                continue
        # pdb.set_trace()
        l2_maxp = side_output['layer5']  #batch*512*8*4
        ...
        l3_maxp = side_output['layer6'] #batch*1024*8*4
