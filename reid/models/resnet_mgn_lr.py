...
#######################
        ...
        fea_test = [g1_rd, g2_rd, p2_1_rd, p2_2_rd, g2_rd_lr, p2_1_rd_lr, p2_2_rd_lr, g3_rd, p3_1_rd, p3_2_rd, p3_3_rd]
        fea_for_test = torch.cat(fea_test, 1)
        if self.norm:
            fea_for_test = F.normalize(fea_for_test)
        if self.test_stage:
